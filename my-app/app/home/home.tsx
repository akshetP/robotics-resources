...
export default function Home() {
  const socialLinks = [
    { icon: '/icons/prime_twitter.svg', href: '#', label: 'Twitter' },
    { icon: '/icons/mdi_linkedin.svg', href: '#', label: 'LinkedIn'},
    { icon: '/icons/mingcute_github-fill.svg', href: '#', label: 'GitHub' },
    { icon: '/icons/mdi_youtube.svg', href: '#', label: 'YouTube'},
    { icon: '/icons/ic_sharp-facebook.svg', href: '#', label: 'Facebook' },
  ];
    ...
    <div className="h-screen p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <h1 className="text-[36px] md:text-[48px] md:text-4xl text-center font-medium text-black mb-2 md:mb-12">
          Robotics Resources by <span className="underline">Akshet Patel</span>
        </h1>
            ...
            <div className="col-span-5">
              <div className="bg-white flex flex-col items-center justify-center w-[350px] h-[480px] rounded-[20px] border-4 border-[#0004FF] shadow-lg">
                ...
                <div className="flex space-x-4 justify-center">
                  <button className="px-6 py-2 bg-[#C2DAFF] rounded-full text-black font-medium shadow-md hover:bg-[#0004FF] hover:text-white transition-colors duration-500">
                    eBook
                  </button>
                  <button className="px-6 py-2 bg-[#C2DAFF] rounded-full text-black shadow-md font-medium hover:bg-[#0004FF] hover:text-white transition-colors duration-500">
                    Print
                  </button>
                </div>
              </div>
            ...
            <div className="col-span-7">
              <div className="grid grid-cols-4 gap-6 mb-8">
                {resourceCards.slice(0, 4).map((card, index) => (
                  <div key={index} className="bg-white w-[166px] h-[166px] rounded-xl p-6 border-2 border-[#0004FF] shadow-md hover:shadow-lg transition-shadow cursor-pointer">
        ...
        <div className="md:hidden space-y-[10px] flex flex-col justify-center items-center">
          ...
          <div className="flex flex-col items-center w-[200px] h-[300px] justify-center bg-white rounded-[20px] p-6 border-2 border-[#0004FF] shadow-lg">
            ...
            <div className="flex space-x-4 justify-center">
              <button className="px-4 py-2 bg-blue-200 rounded-full text-gray-700 font-medium text-sm hover:bg-blue-300 transition-colors">
                eBook
              </button>
              <button className="px-4 py-2 bg-blue-200 rounded-full text-gray-700 font-medium text-sm hover:bg-blue-300 transition-colors">
                Print
          ...
          <div className="grid grid-cols-4 gap-4">
            {resourceCards.map((card, index) => (
              <div key={index} className="bg-white flex flex-col items-center justify-center rounded-xl w-[80px] h-[80px] p-4 border-2 border-[#0004FF] shadow-md hover:shadow-lg transition-shadow cursor-pointer">
